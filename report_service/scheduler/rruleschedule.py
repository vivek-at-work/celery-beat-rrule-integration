...
class rrule(schedules.BaseSchedule):
    RRULE_REPR = (
    ...
    def __eq__(self, other):
        if isinstance(other, rrule):
            return ((self.freq == other.freq) and
                    (self.dtstart ==other.dtstart) and
                    (self.interval ==other.interval) and
                    (self.wkst ==other.wkst) and
                    (self.count ==other.count) and
                    (self.until ==other.until) and
                    (self.bysetpos ==other.bysetpos) and
                    (self.bymonth ==other.bymonth) and
                    (self.bymonthday ==other.bymonthday) and
                    (self.byyearday ==other.byyearday) and
                    (self.byeaster ==other.byeaster) and
                    (self.byweekno ==other.byweekno) and
                    (self.byweekday ==other.byweekday) and
                    (self.byhour ==other.byhour) and
                    (self.byminute ==other.byminute) and
                    (self.bysecond ==other.bysecond))
        return False
