...
from .models import RRuleSchedule,CustomePeriodicTask
...
class ModelEntry(ScheduleEntry):
    ...
    def from_entry(cls, name, app=None, **entry):
        return cls(CustomePeriodicTask._default_manager.update_or_create(
